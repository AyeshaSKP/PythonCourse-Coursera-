...
a_scores=[]
str_list= scores.split(" ")
print(str_list)

# now string to int
#for i in range(0,len(str_list)):
    #tr_list[i]=int(str_list[i])
...
# upper way is correct but since we need variable instead of list do it itn eh follwiing way
...
print(p_phrase)
#r_phrase = p_phrase.split(" ")
#print(r_phrase)
#r_phrase.reverse()
#print(r_phrase)        

#if r_phrase.count == p_phrase:
    #print("True")
#lse:
    #print("False")
# the upper method wont work since ou have to reveese a tring and checn the string not list
r_phrase = p_phrase[:: -1]
print(r_phrase)
...
#for s in inventory:
 #   imv = s.split(",")
  #  name = imv[0]
   # number = imv[1]
    #price = imv[2]
    #rint("The store has{} {}, each for{} USD.".format(amount, product, price))

#print(inv)

#print(inv)
# it wont work since it will be indexing s in a worng way like diving shoes instead of shoes, 12, 29.99
#for s in inventory:
 #   name = s[0]
  #  number = s[1]
   # price = s[2]
